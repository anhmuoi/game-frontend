...
class UserManagementToolbar extends React.Component {
  state = {
    showExport: false,
    showImport: false,
    showDialog: false,
  ...
  redirectTo = () => {
    this.props.history.replace('/user/add');
  };
...
export default withStyles(toolbarStyles)(UserManagementToolbar);
