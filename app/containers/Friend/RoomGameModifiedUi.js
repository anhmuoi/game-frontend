...
class MarketModifiedUi extends React.PureComponent {
  onSaveMarket = () => {
    ...
    const friendApi = mapModelMarketUiToApi(friendDataModified);
    if (rowsSelectedId) {
      onUpdateMarket(rowsSelectedId, friendApi);
    } else {
      onAddMarket(friendApi);
    }
    return true;
  };
...
MarketModifiedUi.propTypes = {
  ...
  friendDataModified: PropTypes.object,
