...
class MarketManagementToolbar extends React.Component {
  state = {
    showDialog: false,
  };
              ...
              <React.Fragment>
                <div>
                  <Typography variant="h6" id="tableTitle">
                    <FormattedMessage {...messages.titleMarket} />
                  </Typography>
                </div>
              </React.Fragment>
            </Hidden>
...
MarketManagementToolbar.propTypes = {
...
export default withStyles(toolbarStyles)(MarketManagementToolbar);
