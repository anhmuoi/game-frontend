...
class MarketModifiedUi extends React.PureComponent {
  onSaveMarket = () => {
    ...
    const myGroupApi = mapModelMarketUiToApi(myGroupDataModified);
    if (rowsSelectedId) {
      onUpdateMarket(rowsSelectedId, myGroupApi);
    } else {
      onAddMarket(myGroupApi);
    }
    return true;
  };
...
MarketModifiedUi.propTypes = {
  ...
  myGroupDataModified: PropTypes.object,
