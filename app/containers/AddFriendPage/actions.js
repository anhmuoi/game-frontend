 ...
 */
export function addFriend(token, newPass, confirmPass) {
  return {
    type: JOIN_GROUP,
    token,
    newPass,
...
export function addFriendSuccess(message) {
  return {
...
export function confirmAddFriend(userId1, userId2, confirm, token) {
  return { type: CONFIRM_JOIN_GROUP, userId1, userId2, confirm, token };
}
