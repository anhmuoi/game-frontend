...
class RoomDetailManagementToolbar extends React.Component {
  state = {
    showDialog: false,
  };
              ...
              <React.Fragment>
                <div>
                  <Typography variant="h6" id="tableTitle">
                    <FormattedMessage {...messages.titleRoomDetail} />
                  </Typography>
                </div>
              </React.Fragment>
            </Hidden>
...
RoomDetailManagementToolbar.propTypes = {
...
export default withStyles(toolbarStyles)(RoomDetailManagementToolbar);
