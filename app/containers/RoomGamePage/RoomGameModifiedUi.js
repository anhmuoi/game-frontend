...
import { validateRoomGame } from './actions.js';
...
class RoomGameModifiedUi extends React.PureComponent {
  onSaveRoomGame = () => {
    ...
    const roomGameApi = mapModelRoomGameUiToApi(roomGameDataModified);
    if (rowsSelectedId) {
      onUpdateRoomGame(rowsSelectedId, roomGameApi);
    } else {
      onAddRoomGame(roomGameApi);
    }
    return true;
  };
...
export function mapDispatchToProps(dispatch) {
  return {
    onValidateRoomGame: (errors) => dispatch(validateRoomGame(errors)),
  };
}
...
export default compose(
  ...
  withReducer,
  injectIntl,
)(withStyles(styles)(RoomGameModifiedUi));
