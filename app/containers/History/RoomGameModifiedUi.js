...
class MarketModifiedUi extends React.PureComponent {
  onSaveMarket = () => {
    ...
    const historyApi = mapModelMarketUiToApi(historyDataModified);
    if (rowsSelectedId) {
      onUpdateMarket(rowsSelectedId, historyApi);
    } else {
      onAddMarket(historyApi);
    }
    return true;
  };
...
MarketModifiedUi.propTypes = {
  ...
  historyDataModified: PropTypes.object,
