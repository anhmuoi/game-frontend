...
class MarketModifiedUi extends React.PureComponent {
  onSaveMarket = () => {
    ...
    const ChangePasswordApi = mapModelMarketUiToApi(ChangePasswordDataModified);
    if (rowsSelectedId) {
      onUpdateMarket(rowsSelectedId, ChangePasswordApi);
    } else {
      onAddMarket(ChangePasswordApi);
    }
    return true;
  };
...
MarketModifiedUi.propTypes = {
  ...
  ChangePasswordDataModified: PropTypes.object,
