...
import { validateRoomManage } from './actions.js';
import messages from './messages.js';
import reducer from './reducer.js';

import { mapModelRoomManageUiToApi } from './functions.js';
import { styles } from './styles.js';

// const localUsername = localstoreUtilites.getUsernameFromLocalStorage();
class RoomManageModifiedUi extends React.PureComponent {
  onSaveRoomManage = () => {
    const {
    ...
    const roomManageApi = mapModelRoomManageUiToApi(roomManageDataModified);
    if (rowsSelectedId) {
      onUpdateRoomManage(rowsSelectedId, roomManageApi);
    } else {
      onAddRoomManage(roomManageApi);
    }
    return true;
  };
...
RoomManageModifiedUi.propTypes = {
  ...
  roomManageDataModified: PropTypes.object,
  onChangeTextField: PropTypes.func,
  classes: PropTypes.object.isRequired,
  title: PropTypes.oneOfType([PropTypes.string, PropTypes.object]),
  onUpdateRoomManage: PropTypes.func,
  onAddRoomManage: PropTypes.func,
  onValidateRoomManage: PropTypes.func,
  intl: PropTypes.any,
};

RoomManageModifiedUi.defaultProps = {
  openModal: false,
  title: 'Add roomManage',
};

export function mapDispatchToProps(dispatch) {
  return {
    onValidateRoomManage: (errors) => dispatch(validateRoomManage(errors)),
  };
}
...
export default compose(
  ...
  withReducer,
  injectIntl,
)(withStyles(styles)(RoomManageModifiedUi));
