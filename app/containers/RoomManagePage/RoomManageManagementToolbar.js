...
class RoomManageManagementToolbar extends React.Component {
  state = {
    showDialog: false,
  };
              ...
              <React.Fragment>
                <div>
                  <Typography variant="h6" id="tableTitle">
                    <FormattedMessage {...messages.titleRoomManage} />
                  </Typography>
                </div>
              </React.Fragment>
            </Hidden>
...
RoomManageManagementToolbar.propTypes = {
...
export default withStyles(toolbarStyles)(RoomManageManagementToolbar);
