...
class MarketModifiedUi extends React.PureComponent {
  onSaveMarket = () => {
    ...
    const analysisApi = mapModelMarketUiToApi(analysisDataModified);
    if (rowsSelectedId) {
      onUpdateMarket(rowsSelectedId, analysisApi);
    } else {
      onAddMarket(analysisApi);
    }
    return true;
  };
...
MarketModifiedUi.propTypes = {
  ...
  analysisDataModified: PropTypes.object,
