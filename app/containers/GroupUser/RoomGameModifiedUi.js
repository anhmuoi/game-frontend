...
class MarketModifiedUi extends React.PureComponent {
  onSaveMarket = () => {
    ...
    const groupUserApi = mapModelMarketUiToApi(groupUserDataModified);
    if (rowsSelectedId) {
      onUpdateMarket(rowsSelectedId, groupUserApi);
    } else {
      onAddMarket(groupUserApi);
    }
    return true;
  };
...
MarketModifiedUi.propTypes = {
  ...
  groupUserDataModified: PropTypes.object,
