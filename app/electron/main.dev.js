...
// const mainURL = `${indexPath}/index.html`;
const mainURL = electronSettings.has('host')
  ? electronSettings.get('host')
  : `https://demo.demasterpro.com`;

if (!electronSettings.has('host')) {
  electronSettings.set('https://demo.demasterpro.com');
}
...
function createMainWindow() {
  ...
  electronSettings.watch('host', (newValue, oldValue) => {
    try {
      console.log(newValue);
      win.loadURL(newValue);
    } catch (error) {
      win.loadURL(oldValue);
    }
  });
